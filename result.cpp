...
void Result::Init()
{
	...
	AddGameObject<Polygon2D>(2)->Init((SCREEN_WIDTH / 2) - 350.0f, 50.0f, 700, 350, "asset\\texture\\text\\ResultText1.png");
	AddGameObject<Polygon2D>(2)->Init(450.0f + 200.0f + 10.0f, SCREEN_HEIGHT / 2 + 50.0f, 200, 60, "asset\\texture\\text\\ResultText2.png");

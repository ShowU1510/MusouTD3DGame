...
private:
	...
	static void LoadModelMagica(const char* FileName, MODEL* Model);
	static void LoadObj(const char* FileName, MODEL_OBJ* ModelObj);
	static void LoadObjMagica(const char* FileName, MODEL_OBJ* ModelObj);
...
public:
	...
	void LoadMagica(const char* FileName);
	void Draw() override;
	void DrawMagica();
